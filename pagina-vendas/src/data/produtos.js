export const produtos = [
  ...
  },
  {
    ...
    categoria: "Acessórios",
    preco: "R$ 39,99",
    descricao: "Cinta de Amarração com Catraca – 800kg | Jet Ski, Moto e Cargas\nSegurança máxima para o transporte do seu patrimônio.\n\nSeja para levar o seu Jet Ski até a água, transportar sua moto em uma caçamba ou prender cargas em carretinhas, esta cinta com catraca é o acessório indispensável para garantir que nada saia do lugar durante o trajeto. Desenvolvida com materiais de alta resistência, ela oferece estabilidade total e facilidade no manuseio.\n\n🛡️ Especificações Técnicas\nCapacidade de Carga: Suporta até 800 kg por peça, garantindo segurança para cargas pesadas.\n\nComprimento da Fita: 4,3 metros de extensão total para diversas aplicações.\n\nLargura da Fita: 2,5 cm (25mm), oferecendo uma área de contato firme.\n\nAjuste Versátil: Comprimento totalmente ajustável entre 0,3 m e 4,3 m.\n\nCores: Envio em cores aleatórias conforme disponibilidade (preto ou laranja).\n\n💎 Diferenciais e Materiais\nFita de Poliéster: Material de alta tenacidade que não estica e resiste a intempéries.\n\nCatraca Reforçada: Mecanismo em aço com tratamento anticorrosivo, ideal para uso em ambientes náuticos.\n\nGanchos Protegidos: Revestimento em vinil, projetado para não riscar a pintura do seu veículo ou equipamento.\n\nTrava de Segurança: Sistema com catraca de liberação rápida e trava firme.",
    fichaTecnica: { "Marca": "Malaysia Collection", "Capacidade": "Até 800kg", "Comprimento": "De 0,3m até 4,3m" },
    imagens: ["https://http2.mlstatic.com/D_NQ_NP_2X_694022-MLB106976576998_022026-F.webp",
  ...
  },
  {
    ...
    categoria: "Acessórios",
    preco: "R$ 39,99",
    descricao: "Cinta de Elevação Sling 2 Toneladas – 1 Metro | Alta Resistência e Segurança\nPotência e confiabilidade para movimentação de cargas pesadas.\n\nEsta cinta de elevação tipo sling é a solução ideal para trabalhos pesados que exigem máxima segurança e durabilidade. Projetada para suportar condições rigorosas, ela oferece a flexibilidade necessária para o manuseio de materiais sensíveis sem comprometer a força bruta exigida em canteiros de obras, oficinas e logística.\n\nSegurança em Primeiro Lugar (Fator 7:1)\nDiferente de cintas comuns, este modelo possui um Fator de Segurança de 7:1. Isso significa que sua carga de ruptura é sete vezes maior que a carga de trabalho, garantindo tranquilidade absoluta contra rompimentos acidentais durante a operação.\n\nEspecificações Técnicas:\n\nCapacidade de Carga: 2 Toneladas (cor verde seguindo padrões internacionais).\n\nComprimento Total: 1 Metro.\n\nLargura da Fita: 60 mm.\n\nModelo: Sling com Olhal em ambas as extremidades para fácil ancoragem.\n\nMaterial: Poliéster de alta tenacidade (leve, flexível e resistente à abrasão).",
    fichaTecnica: { "Marca": "Multifitas", "Comprimento x Largura": "1 m x 6 cm", "Capacidade": "2 Toneladas", },
    imagens: ["https://http2.mlstatic.com/D_NQ_NP_2X_965739-MLA99842164523_112025-F.webp",
